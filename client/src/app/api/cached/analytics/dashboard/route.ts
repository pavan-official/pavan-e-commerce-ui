...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get key metrics in parallel with optimized queries
    const [
      totalRevenue,
      todayRevenue,
      yesterdayRevenue,
      ...
      // Top products with optimized query
    ...
    // Cache the result for 15 minutes (shorter for real-time feel)
    ...
    console.error('Error fetching cached dashboard analytics:', error)
    return NextResponse.json(
      {
        success: false,
        error: {
